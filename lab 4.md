...
Ось текст без смайликів:


---

1. Як вивести вміст директорії /proc? Де вона знаходиться та для чого призначена?
...
2. Як вивести інформацію про поточні сеанси користувачів
...
3. Комбінації клавіш у терміналі
...
4. Чим відрізняється фоновий процес від звичайного
...
6. Як переглянути інформацію про запущені в системі фонові процеси та задачі
...
Хочеш, щоб я оформив це як короткий конспект або шпаргалку в зручному форматі (наприклад, PDF або таблиця)?
